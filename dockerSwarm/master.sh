...
ocker run --restart=unless-stopped -d -p 3375:2375  -v /root/certs:/certs:Z swarm manage --tls --tlscacert=/certs/ca.pem --tlscert=/certs/server-cert.pem --tlskey=/certs/server-key.pem token://$a
echo "Token is " + $a
